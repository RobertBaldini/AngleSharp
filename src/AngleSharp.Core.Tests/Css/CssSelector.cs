...
<div>
    <span>Fifth</span>
        ...
        [Test]
        public void ShouldReturnUniqueSelectorsForDivAndSpanWithSameId_IssueXXX() {
            var html = @"<dd>
                        ...
                        <span>
                            <span id=""first"">Sub1</span>
                        </span>
                        </dd>";
            var document = html.ToHtmlDocument();

            var bothMatchingElements = document.QuerySelectorAll("#first").ToList();
            ...
            Assert.AreEqual("body>dd>div:nth-child(1)", divSelector);
